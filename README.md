...
- To run this application, clone the `blazor-scheduler-crud` repository.
- Navigate to its appropriate path where it has been located in your system.
- Open the soultion in visual studio 2019.
- Run the sample using the below command.
    ```bash
    dotnet run
    ```
